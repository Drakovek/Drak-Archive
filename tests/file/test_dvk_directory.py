...
class TestDvkDirectory(unittest.TestCase):
    ...
    def test_sort_dvks_alpha(self):
        """
        Tests alpha-numeric sorting with the sort_dvks functions.
        """
        ...
        value = ["Guy", "Other Guy"]
        assert self.dvk_directory.get_dvk(3).get_artists() == value
        assert self.dvk_directory.get_dvk(3).get_title() == "DVK 2"
        assert self.dvk_directory.get_dvk(4).get_artists() == value
